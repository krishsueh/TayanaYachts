...
namespace TayanaYachts
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void BindDealerFront()
        {
            ...
            string sql = "SELECT dealers.*, dealersCountry.Country, dealersArea.Area FROM dealers INNER JOIN dealersArea ON dealers.AreaID = dealersArea.AreaID INNER JOIN dealersCountry ON dealersArea.CountryID = dealersCountry.CountryID";
        ...
        protected void ddl_AreaSorting_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //顯示篩選結果
            if (ddl_AreaSorting.SelectedValue != "0")
            {
